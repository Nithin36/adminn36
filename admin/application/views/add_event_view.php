...
<!--                                    <div class="form-group">
     ...
     <div class="form-group">
                                        <label>Set as Current Event</label>
                                        <select class="form-control" name="status">
                                      

                                            <option value="0" <?php if(!empty($postdata)){if($postdata['status']==0) {?> selected="selected" <?php }}?>>No</option>
                                            <option value="1" <?php if(!empty($postdata)){if($postdata['status']==1) {?> selected="selected" <?php }}?>>Yes</option>
